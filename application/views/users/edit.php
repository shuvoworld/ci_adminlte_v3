						...
						<div class="card-body">
							...
							<div class="row">
								<div class="form-group col-3">
									...
									<input type="text" id="first_name" name="first_name" value="<?php echo $user_data['first_name'] ?>" class="form-control">
								</div>
								<div class="form-group col-3">
									<label for="groupName">Last Name</label>
									<input type="text" id="last_name" name="last_name" value="<?php echo $user_data['last_name'] ?>" class="form-control">
								</div>
								<div class="form-group col-3">
							...
							<div class="row">
								<div class="form-group col-3">
									...
									<input type="text" id="username" name="username" value="<?php echo $user_data['username'] ?>" class="form-control">
								</div>
								<div class="form-group col-3">
								...
								<div class="form-group col-3">
									...
									<select name="group_id" id="group_id" class="form-control  custom-select" style="width: 100%;">
